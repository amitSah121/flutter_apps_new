...
import 'package:page_editor/custom_markdown.dart';
import 'package:page_editor/file_funcs.dart';
import 'package:page_editor/image_video_funcs.dart';
import 'package:page_editor/model.dart';
import 'package:page_editor/video_player.dart';
                ...
                children: [
                  Padding(
                    ...
                    child: (isImage
                      ...
                      : Image.file(
                          File("/storage/emulated/0/PageEditor/$t2"),
                          width: width,
                          height: height,
                          fit: BoxFit.cover,
                        )
